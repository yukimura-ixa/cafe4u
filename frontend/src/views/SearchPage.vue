      ...
      <div class="columns">
        ...
        <div class="column is-offset-3 is-4 has-text-right">
          ...
          <span class="select is-primary" >
                    <select style="background-color:rgb(219, 255, 217)" v-model="filterType">
                      <option value="none" >None</option>
                      <option :value="type.cafe_theme" v-for="type in searchCafe[3]" :key="type.cafe_theme" class="is-capitalized">{{type.cafe_theme}}</option>
                    </select>
          </span>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-image">
                  <figure class="image is-4by3">
                    <img :src="showImage(cafe.cafe_branchid)" alt="Placeholder image" />
                  </figure>
                </div>
...
export default {
  ...
  methods: {
    ...
    showImage(cafe_id){
      ...
      if(image[0]==null){return 'https://www.paiduaykan.com/travel/wp-content/uploads/2020/04/1-SON09231.jpg'}
      return image[0].image_path
    }
  },
  computed:{
    searchList(){
      if(this.filterType == 'none'){return this.searchCafe[1]}
